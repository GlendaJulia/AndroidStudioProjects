...
public class MainActivity extends AppCompatActivity {
    ...
    public void Logear(View v){
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                ...
                String url = "http://192.168.43.49:8080/WebApp05.1/rest/usuarios/login?";
                ...
                JsonArrayRequest stringRequest = new JsonArrayRequest(url, new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        try{
                            ...
                            Toast.makeText(getApplicationContext(),"Error en la data recibida",
                                    Toast.LENGTH_LONG).show();
                        }
                    }
    ...
    public void addUsuario(View v){
        Intent addUsuaurio = new Intent(this, registro.class);
