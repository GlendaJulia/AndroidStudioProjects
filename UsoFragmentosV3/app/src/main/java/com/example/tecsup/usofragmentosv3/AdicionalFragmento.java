...
public class AdicionalFragmento extends Fragment {
    ...
    Button btnOperaciones, btnRespuesta;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnOperaciones = view.findViewById(R.id.btnOperaciones);
        btnRespuesta = view.findViewById(R.id.btnRespuesta);

        btnOperaciones.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FragmentoOperaciones frmOperaciones = new FragmentoOperaciones();
                FragmentTransaction transaccion = getActivity().getSupportFragmentManager().beginTransaction();
                transaccion.replace(R.id.contenedor2,frmOperaciones);
                transaccion.commit();
            }
        });
        return view;
